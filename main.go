...
func setup() {
	...
	// for i := range buttonStates {
	// 	buttonStates[i].lastDebounceTime = time.Now()
	// }

	// buttonStates = make([]buttons, 8)
	// for i := range buttonStates {
	// 	buttonStates[i].lastDebounceTime = time.Now()
	// }
}
...
func buttonAction(b Buttons) {
	// t1 := b.buttonPressedTime.Add(buttonLongPressTime)
	// t2 := b.buttonPressedTime.Add(buttonLongPressTime).After(b.buttonReleasedTime)
